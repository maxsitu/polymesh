...
/**
  * This is an event sourced entity. It has a state, [[PolymeshState]], which
  ...
  */
class PolymeshEntity extends PersistentEntity {

  override type Command = PolymeshCommand[_]
  override type Event = PolymeshEvent
  override type State = PolymeshState
...
object PolymeshEvent {
  val Tag: AggregateEventTag[PolymeshEvent] = AggregateEventTag[PolymeshEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends PolymeshEvent
...
/**
  * This interface defines all the commands that the PolymeshEntity supports.
  */
sealed trait PolymeshCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends PolymeshCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends PolymeshCommand[String]
...
/**
  ...
  * application loader.
  */
object PolymeshSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[PolymeshState]
  )
}
